    ...
    <form method="post" action="./api/edit.php">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <input type="button" value="更新圖片" onclick="op('#cover','#cvr','./modal/upload_admin.php?id=<?= $row['id']; ?>')">
        ...
        <table style="margin-top:40px; width:70%;">
            <tbody>
                <tr>
                    <td width="200px">
                        <input type="button" onclick="op('#cover','#cvr','./modal/admin.php')" value="新增網站標題圖片">
                    </td>
                    <td class="cent">
